...
def runPOE(data):
  ...
  poe_env["DXVK_HUD"] = "fps,pipelines"
  poe_env["DXVK_ASYNC"] = "1"
  poe_env["DXVK_STATE_CACHE"] = "1"
  poe_env["DXVK_USE_PIPECOMPILER"] = "1"
  poe_env["DXVK_USE_PLACEHOLDER_SHADERS"] = "1"
